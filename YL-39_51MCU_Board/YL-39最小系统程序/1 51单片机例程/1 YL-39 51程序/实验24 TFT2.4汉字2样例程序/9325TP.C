...
LCD_PutString(2,40,"http://ylelectronic.taobao.com/",Red,Blue);                  ///前景颜色和背景颜色，可以直接预定义，也可以直接填入16进制数字
LCD_PutString(40,60,"I LOVE MY JOB ",Blue2,Yellow);
LCD_PutString(40,80,"北京雁凌电子有限公司",Magenta,Green);
...
PutGB3232(20,240,"北",Blue,0X00);	
PutGB3232(60,240,"京",Blue,0X00);	
PutGB3232(100,240,"雁",Blue,0X00);	
PutGB3232(140,240,"凌",Blue,0X00);	
